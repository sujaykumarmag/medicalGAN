...
def main():
    ...
    train_dir = '../../data/train/new_train/'  
    val_dir = '../../data/test'  
    

    train_dataset = MedicalImagesDataset(train_dir, transform=transforms)
    val_dataset = MedicalImagesDataset(val_dir, transform=transforms)
    
    # Assuming your dataset has a class-to-index mapping
    class_to_idx_mapping = val_dataset.class_to_idx
    # Print the class-to-index mapping
    print("Class-to-Index Mapping for Val Dataset:")
    print(class_to_idx_mapping)

    # Assuming your dataset has a class-to-index mapping
    class_to_idx_mapping = train_dataset.class_to_idx
    # Print the class-to-index mapping
    print("Class-to-Index Mapping for Train Dataset:")
    print(class_to_idx_mapping)
    ...
    TrainEval(args, model, train_loader, val_loader, optimizer, criterion, device).train()
    torch.save(model,"models/Pneu-ViT.pth")
